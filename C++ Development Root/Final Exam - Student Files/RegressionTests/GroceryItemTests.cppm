  ...
  void GroceryItemTests::io()
  {
    ...
    { // field and delimiter validation
      GroceryItem const control{ "abcdefg", "1234567", "uvwxyz", 77.5 };
      {
        ...
        std::ios::fmtflags originalState = stream.flags();
        GroceryItem        variant;
        ...
        affirm.is_equal( "Stream state validation-1: whitespace", static_cast<std::size_t>( originalState ), static_cast<std::size_t>( stream.flags() ) );
