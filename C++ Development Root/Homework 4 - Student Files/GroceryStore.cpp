...
/***********************************************************************************************************************************
**  Module GroceryStore Implementation
**
***********************************************************************************************************************************/
///////////////////////// TO-DO (1) //////////////////////////////
...
GroceryStore::GroceryStore( const std::string & persistentInventoryDB )
{
  ...
  if( !fin.is_open() )  std::print( std::cerr, "Warning:  Could not open persistent inventory database file {:?}.  Proceeding with empty inventory\n\n", persistentInventoryDB );
  ...
  ///////////////////////// TO-DO (2) //////////////////////////////
    ...
    ///        3) Implementation examples and quoted_string_patch.inc
    /// Several implementations "work", but they are not all the same.  Give considerable though to how many times you are coping
    /// and/or moving items.
...
{
  auto & worldWideGroceryDatabase = GroceryItemDatabase::instance();                          // Get a reference to the worldwide database of all groceries in the world. The
                                                                                              // database is indexed by UPC and contains a full description of the item and the
                                                                                              // item's price.
  ...
  ///////////////////////// TO-DO (3) //////////////////////////////
    ...
    ///       2.1          If the item is not found in the worldwide grocery item database, indicate on the receipt it's free of charge
    ///       2.2          Otherwise
...
{
  auto & worldWideGroceryDatabase = GroceryItemDatabase::instance();                          // Get a reference to the worldwide database of all
  ...
  ///////////////////////// TO-DO (5) //////////////////////////////
    ...
    ///        1.1.1           If the grocery item is not in the worldwide grocery item database,
...
GroceryStore::ShoppingCarts GroceryStore::makeShoppingCarts() const
{
