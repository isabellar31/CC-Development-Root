...
/***********************************************************************************************************************************
**  Module Regression.GroceryItemDatabaseTests
**
***********************************************************************************************************************************/
export module Regression.GroceryItemDatabaseTests;
import std;
import GroceryItem;
...
{
  class GroceryItemDatabaseTests
  {
    public:
      GroceryItemDatabaseTests();
...
namespace Regression
{
  ...
  //
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  static GroceryItemDatabaseTests run_groceryItemDatabase_tests;
  ...
  void GroceryItemDatabaseTests::tests()
  {
    GroceryItemDatabase & db           = GroceryItemDatabase::instance();
    std::size_t           expectedSize = 0;
    auto                  db_find      = [&db]( const auto & key ) -> GroceryItem * { return db.find( GroceryItemDatabase::Key{key} ); };
    ...
    if( auto p = db_find( "00014100072331" ); p == nullptr )
    {
...

    {
      ...
      // GroceryItemDatabase importing what I need here.  By creating a struct that mirrors the attribute layout of the
      ...
      // The types and quantities can't possibly be identical if the sizes don't match. It's pretty weak, but better than nothing.
      ...
      else
      {
        ...
        auto groceryItem = db_find( "00014100072331" );
  ...
  GroceryItemDatabaseTests::GroceryItemDatabaseTests()
  {
    //affirm.policy = Regression::CheckResults::ReportingPolicy::BRIEF;
    affirm.name_width = 65;
