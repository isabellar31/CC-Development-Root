...
/***********************************************************************************************************************************
**  Module Regression.GroceryStoreTests
**
***********************************************************************************************************************************/
export module Regression.GroceryStoreTests;
...
/***********************************************************************************************************************************
**  Module Regression.GroceryItemDatabaseTests Implementation
...
namespace  Regression
{
  ...
  //
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  static GroceryStoreTest run_GroceryStore_tests;
  ...
  GroceryStoreTest::GroceryStoreTest()
  {
    try
    {
      // It is anticipated the implementation of the functions under test will write data to standard output. Capture and (for now) ignore
      // standard output from called functions only for the duration of these tests.  We may wish to inspect the contents of this output at a
      // future date.  These tests look at and validate the function's returned parameters and side affects, but not what they write to
      // standard output.
  ...
  void GroceryStoreTest::validate( const GroceryStore::Inventory_DB & actualInventory, const GroceryStore::Inventory_DB & expectedInventory )
  {
    bool allPassed = true;
  ...
  void GroceryStoreTest::test_1( const GroceryStore::Inventory_DB & inventory )
  {
  ...
  void GroceryStoreTest::test_2( const GroceryStore::Inventory_DB & inventory )
  {
  ...
  void GroceryStoreTest::test_3( const GroceryStore::Inventory_DB & inventory )
  {
  ...
  void GroceryStoreTest::test_4( const GroceryStore::GroceryItemsSold & soldGroceryItems, const GroceryStore::Inventory_DB & inventory )
  {
    ...
    affirm.is_equal( "Items sold today - content", expectedList,        soldGroceryItems );
    ...
    affirm.is_equal( "Items to reorder - content", expectedGroceryItemsToReorder, groceryItemsToReorder );
  }
