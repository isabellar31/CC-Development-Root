...
int main()
{
  try
  {
    { // Design Note:  I/O executed before main (e.g., regression tests) are not affected
      std::locale locale{ "en_PH.UTF-8" };    // PH Philippines               // Select the locale
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      /// groceries by using your store's makeShoppingCarts function to create a constant collection of shopping carts.
      ///
